...
public class StringListZip {
    ...
    public static void main(String[] args) {
        ...
        StringListZip zip = new StringListZip("/Users/hibaqutbuddinhabib/IdeaProjects/hashTabel/src/postnummer.csv");
        ...
        System.out.println("linear 111 20: " + zip.linearLookup("111 20") + (timeSt - times) / k + "ns");

        // warm up so that we hopefully get better benchmark results
        for (int i = 0; i < k; i++) {
            zip.linearLookup("570 83");
        }
        ...
        timeStop = System.nanoTime();
        System.out.println("linear 570 83: " + zip.linearLookup("570 83") + (timeSt - times) / k + "ns");

        // warm up so that we hopefully get better benchmark results
        for (int i = 0; i < k; i++) {
            zip.binaryLookup("111 20");
        }
        ...
        timeStop = System.nanoTime();
        System.out.println("binary 111 20: " + zip.binaryLookup("111 20") + (timeSt - times) / k + "ns");

        // warm up so that we hopefully get better benchmark results
        for (int i = 0; i < k; i++) {
            zip.binaryLookup("57083");
        }
        ...
        timeStop = System.nanoTime();
        System.out.println("binary 57083: " + zip.binaryLookup("57083") + (timeSt - times) / k + "ns");
    }
}