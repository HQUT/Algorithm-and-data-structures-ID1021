...
public class ListZip {
     ...
     * @param fileName
     */
    public ListZip(String fileName) {
    ...
    public static void main(String[] args) {
        ...
        ListZip zip = new ListZip("/Users/hibaqutbuddinhabib/IdeaProjects/hashTabel/src/postnummer.csv");
        ...
        timeStart = System.nanoTime();
        for (int i = 0; i < k; i++) {
            zip.linearLookup(57083);
        }
        timeStop = System.nanoTime();
        System.out.println("linear 57083: " + zip.linearLookup(57083) + (timeStop - timeStart) / k + "ns");
        for (int i = 0; i < k; i++) {
        ...
        timeStop = System.nanoTime();
        System.out.println("binary 57083: " + zip.binaryLookup(57083) + (timeStop - timeStart) / k + "ns");
